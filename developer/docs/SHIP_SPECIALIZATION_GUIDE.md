...
Evolved from Valkyrie, carrying tall ground vehicles or 180 SCU. The atmosphere modifier (×0.85) matches the Valkyrie. Not a primary hauler but flexible for mixed operations.
...
4. Changes take effect immediately on the next scorer run, with no restart needed.
