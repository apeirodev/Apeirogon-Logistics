...
When you sit down to haul, open this project, start a new conversation, and paste `session_start_prompt.md` to tell Claude your ship and location. Then start pasting screenshots.
